...
With these lemmas under our belt, we can show show \Cref{prop:mlr_sel_dom}. Since $p \sim_{P_{\theta_0}} \text{Unif}([0, 1])$, this proposition is sufficient to imply selective dominance. 
