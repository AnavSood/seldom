...
\end{equation*}
is at most $\alpha$. For many selective inference procedures, $s(x)$ turns out to be simple enough that this adjustment is computable is closed form, and the resulting procedure is easy to interpret. As we explain in \Cref{sec:dominance}, essentially all the p-values researchers commonly satisfy our selective dominance condition. 
