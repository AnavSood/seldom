...
\begin{align*}
    ...
    & =P_{\mu_1, \mu_2}(p_{21} < \alpha | W = 2)P(W=2I()\mu_2 < \mu_1) & \text{(no false rejection when $W=1$ or $\mu_2 =\mu_1$)}\\
...
Considering a class of selection functions $s^{\theta_0}(x)$ under which $p^{\theta_0}$ and $U$ both have a positive probability of selection given, we want to show that the selective p-values from \Cref{thm:adjustment}, 
\begin{equation*}
